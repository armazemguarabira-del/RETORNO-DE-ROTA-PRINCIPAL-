            ...
            <nav className="flex flex-wrap items-center justify-center gap-2 bg-slate-950/60 p-2 rounded-2xl border border-slate-800/80 max-w-full shadow-inner">
              {currentUser.role === 'empilhador' && (
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer border ${
                    activeTab === 'carregamento' || activeTab === 'descarregamento'
                ...
                >
                  ...
                  <span>Descarregamento & Empilhador</span>
                </button>
              )}
              ...
              {currentUser.role === 'conferente' && (
                <>
                  ...
                  <button
                    id="nav_conferente_carregamento"
                    onClick={() => setActiveTab('carregamento')}
                    className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer border ${
                      activeTab === 'carregamento' || activeTab === 'descarregamento'
                        ? 'bg-amber-500 text-slate-950 border-amber-600 shadow-md font-black scale-[1.01]' 
              ...
              {(currentUser.role === 'auxiliar_logistica' || currentUser.role === 'financeiro') && (
                <>
                  ...
                  <button
                    id="nav_auxiliar_backup"
                    onClick={() => setActiveTab('backup')}
                    className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer border ${
                      activeTab === 'backup' || activeTab === 'exportar'
                        ? 'bg-blue-600 text-white border-blue-500 shadow-md font-black scale-[1.01]' 
                        : 'text-blue-300 bg-blue-950/40 border-blue-900/60 hover:text-white hover:bg-blue-900/60'
                    }`}
                  >
              ...
              {currentUser.role === 'monitoramento' && (
                <>
                  ...
                  <button
                    id="nav_monitoramento_carregamento"
                    onClick={() => setActiveTab('carregamento')}
                    className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer border ${
                      activeTab === 'carregamento' || activeTab === 'descarregamento'
                        ? 'bg-amber-500 text-slate-950 border-amber-600 shadow-md font-black scale-[1.01]' 
          ...
          {currentUser.role === 'empilhador' && (
            <button
              ...
              className={`px-3 py-1.5 text-xs font-bold rounded-full inline-flex items-center gap-1.5 shrink-0 transition-all ${
                activeTab === 'carregamento' || activeTab === 'descarregamento' ? 'bg-amber-500 text-slate-950 shadow-sm' : 'text-slate-300 bg-slate-800/80 hover:bg-slate-700'
              }`}
            >
          ...
          {(currentUser.role === 'auxiliar_logistica' || currentUser.role === 'financeiro') && (
            <>
              ...
              <button
                onClick={() => setActiveTab('backup')}
                className={`px-3 py-1.5 text-xs font-bold rounded-full inline-flex items-center gap-1.5 shrink-0 transition-all ${
                  activeTab === 'backup' || activeTab === 'exportar' ? 'bg-blue-600 text-white shadow-sm' : 'text-blue-300 bg-blue-950/80 hover:bg-blue-900'
                }`}
              >
